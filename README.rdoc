...
_TAP.out_ is a TAP handler. TAP.out supports TAP-Y/J as well as traditional TAP.
...
translation transparently. Currently TAP.out supports TAP v12 with minor
some limitations.
...
TAP.out supports a variety of output formats. These are selectable via the 
...
TAP.out - Copyright (c) 2010 Rubyworks

TAP.out is licensed under the terms of the *BSD-2-Clause* license.
