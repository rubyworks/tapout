...
This release fixes an error raised when no report format is explicitly speciifed.
Where as it is supposed to defualt to the `dot` reporter. It also adds initial
